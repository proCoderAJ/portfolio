 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ip=z("ArrowUp",[["path",{d:"m5 12 7-7 7 7",key:"hav0vg"}],["path",{d:"M12 19V5",key:"x0mq9r"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`,IC=()=>{const[e,t]=k.useState(!1),[n,r]=k.useState(!1),i=Qi();k.useEffect(()=>{const a=()=>{t(window.scrollY>50)};return window.addEventListener("scroll",a),()=>window.removeEventListener("scroll",a)},[]);const o=a=>{if(r(!1),i.pathname!=="/"){window.location.href=`/#${a}`;return}const l=document.getElementById(a);l&&l.scrollIntoView({behavior:"smooth"})},s=[{id:"home",label:"Home",icon:wC},{id:"about",label:"About",icon:bC},{id:"skills",label:"Skills",icon:Jc},{id:"projects",label:"Projects",icon:iy},{id:"experience",label:"Experience",icon:As},{id:"certifications",label:"Certifications",icon:As}];return m.jsx(jC,{className:e?"scrolled":"",initial:{y:-100},animate:{y:0},transition:{duration:.5},children:m.jsxs(FC,{children:[m.jsx(DC,{onClick:()=>o("home"),whileHover:{scale:1.1},whileTap:{scale:.95},children:"AJ"}),m.jsxs(MC,{isOpen:n,children:[s.map(a=>{const l=a.icon;return m.jsx(Vp,{whileHover:{scale:1.05},whileTap:{scale:.95},children:m.jsxs(AC,{href:`#${a.id}`,onClick:u=>{u.preventDefault(),o(a.id)},className:i.hash===`#${a.id}`?"active":"",children:[m.jsx(l,{}),a.label]})},a.id)}),m.jsx(Vp,{whileHover:{scale:1.05},whileTap:{scale:.95},children:m.jsxs(RC,{to:"/contact",onClick:()=>r(!1),children:[m.jsx(kr,{}),"Contact"]})})]}),m.jsx(LC,{onClick:()=>r(!n),"aria-label":"Toggle mobile menu",children:n?m.jsx(EC,{}):m.jsx(kC,{})})]})})},VC=C.section`
  height: 100vh;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,TP=()=>{const[e,t]=k.useState(0);return k.useEffect(()=>{const n=()=>{const r=window.scrollY,i=document.documentElement.scrollHeight-window.innerHeight,o=r/i;t(o)};return window.addEventListener("scroll",n),()=>window.removeEventListener("scroll",n)},[]),m.jsx(bP,{style:{scaleX:e},initial:{scaleX:0},transition:{duration:.1,ease:"easeOut"}})},EP=()=>m.jsxs(D.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.5},children:[m.jsx(TP,{}),m.jsx(IC,{}),m.jsx(HC,{}),m.jsx(t4,{}),m.jsx(p4,{}),m.jsx(F4,{}),m.jsx(X4,{}),m.jsx(pP,{}),m.jsx(PP,{})]}),jP=C.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
